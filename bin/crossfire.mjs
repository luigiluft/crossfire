#!/usr/bin/env node
/**
 * crossfire — dispatcher for the two ensemble commands.
...
const TARGETS = { review: 'cross-review.mjs', fuse: 'fusion.mjs' };
...
if (!target) { console.error(`Unknown command: "${cmd}". Try: review | fuse  (or --help)`); process.exit(1); }
